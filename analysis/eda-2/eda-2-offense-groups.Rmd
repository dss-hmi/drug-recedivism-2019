...
```{r custom-functions, echo=echoChunks, results = resultsChunk, message=FALSE, warning = warningChunk}
```
...
Please consult [`./analysis/eda-2/eda-2.html`][eda2_path] report to understand the data set displayed in this dynamic pivot table. 

[eda2_path]: 

```{r groups-of-offenses, echo=echoChunks, results = "show", message=FALSE, warning = warningChunk}
```
