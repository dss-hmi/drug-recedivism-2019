...
This document is the annotation layer to [`./manipulation/1-aggregator.R`][path_aggregator] script, which uses the product of  [`./manipulation/1-greeter.R`][path_greeter] to compute counts of conviction events at different aggregation levels, among which we will  distinquish:
